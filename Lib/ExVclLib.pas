...
//      function    INSERTSQL : String ;
 ...
 procedure hlbEhgridListExcel( RvGrid : TDBGridEh ; FileName : String ; bSel : Boolean = True ) ;
...
//==============================================================================
procedure hlbEhgridListExcel( RvGrid : TDBGridEh ; FileName : String ; bSel : Boolean = True ) ;
var Save_Dlg : TSaveDialog;
begin
   if  RvGrid.DataSource.DataSet.Active and not RvGrid.DataSource.DataSet.IsEmpty  then begin
