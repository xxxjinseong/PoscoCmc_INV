  ...
  try
    ...
    begin
      ...
      StrSQL := ' SELECT R.RECV_DT as PROC_INFO1, R.BODY_02 as PROC_INFO2, R.BODY_03 as PROC_INFO3, ' +
                ...
                ' R.MEMO_01, ' +                                                  // 입고실적 구분
                ' R.MEMO_03, ' +                                                  // 적치실적 구분
                ' SUBSTRING(RTRIM(LTRIM(R.MEMO_04)), 1, 2) + ''-'' + SUBSTRING(RTRIM(LTRIM(R.MEMO_04)), 3, 2) + ''-'' + SUBSTRING(RTRIM(LTRIM(R.MEMO_04)), 5, 2) as MEMO_04, ' + // 적치위치
                ' CONVERT([varchar](19), CONVERT(DATETIME, (SUBSTRING(RTRIM(LTRIM(R.MEMO_05)), 1, 8) + '' '' + ' +
                ' STUFF(STUFF(SUBSTRING(RTRIM(LTRIM(R.MEMO_05)),9, 6), 3, 0, '':''), 6, 0, '':'')), 21), 21) as MEMO_05, ' + // 적치일시
                ...
                '     ON RTRIM(LTRIM(R.MEMO_01)) = RTRIM(LTRIM(S.BODY_01)) ' +  // 실적구분
                '    AND RTRIM(LTRIM(R.MEMO_02)) = RTRIM(LTRIM(S.BODY_03)) ' +  // 입고일시
