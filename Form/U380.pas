...
begin
  ...
  if hlbEhgridListExcel(dgInfo, '제품정보 수신' + '_' + FormatDatetime('YYYYMMDD', Now)) then
  begin
  ...
  try
    ...
    begin
      ...
      StrSQL := ' SELECT ' +
                ...
                '      ELSE CONVERT(NUMERIC(9,3), RTRIM(LTRIM(R.BODY_04))) END as BODY_04, ' +  // 중량
                // 생산일시
    ...
    begin
      qryInfo.Close;
      TraceLogWrite('[380] 제품정보 수신 조회 - 에러['+E.Message+'], 쿼리['+StrSQL+']');
    end;
  end ;
end;
